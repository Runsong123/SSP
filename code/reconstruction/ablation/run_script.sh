...
do
echo $shape
python run_SSN_Fitting_thingi_new_v1_rebuttal_v1_empty_sample_v5_precalc_v2_compare_ablation_PE.py --dataset thingi --outdir ABLATION_PE  --shape $shape --nepoch 10000 
done