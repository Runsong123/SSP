...
if __name__ == "__main__":
    ...
    #     "empty_uniform_v5_precalc_v2_signed_PE_6", "empty_uniform_v5_precalc_v2_signed_PE_3", "ABLATION_signed_distance_supervision", "POCO", "POCO_V1", "POCO_V2", "POCO_V3",
    #     "SPSR_DP", "NDC", "Neural_IMLS"
    # ]
    methods_name = [
        "SAP",  "SSNFitting_CVPR_10000_EPOCH", "DiGS_official_epoch", "Neural_IMLS", "SIREN_wo_n", "IDF", "DiGS_w_calculated", "DiGS_w_calculated_really"
    ]
    ...
    metric_save_dir = "CVPR_metric_main_compares_thingi_orientation"
