...
def generate_dir():
    ...
    data2SaveMeshDir["deep_geometric_prior_data"] = "scaled_challenging_data/"
...
if __name__ == "__main__":
    ...
    data_type = ["deep_geometric_prior_data"]
    ...
    # base_dir = "/research/d5/gds/rszhu22/SSN_Fitting_current/code_v8/evaluate/"
    ...
    # methods_name=["Our", "SAP","NP", ""]
    # methods_name=["derivative_ablation", "signed_ablation"]
    # method_names = ["Our", "SAP","NP", "DeepMLS", "derivative_ablation", "signed_ablation", "compare_traditional_sample"]
    methods_name = ["SAP", "NP", "SAL", "SALD", "IGR", "DeepMLS", "DiGS_official_epoch", "SSNFitting_CVPR_10000_EPOCH", "PSR", "POCO_V2"]
    ...
    metric_save_dir = "Evaluation_v1_metric_main_compares_SRB_v1"
    ...
    for idx, type_item in enumerate(data_type):
        ...
        # shape_list = ["dc", "gargoyle", "lord_quas"]
        ...
        for method_idx, method_item in enumerate(methods_name):
            ...
            save_dir = "Evaluation_v1_SRB_%s_%s_%dp_epoch_final_compare_all_CVPR111111" % (method_item, type_item, n_points)
            ...
            for shape_item in shape_list:
                ...
                # gt_shape_path = "/research/dept6/khhui/SSN_Fitting/raw_data/deep_geometric_prior_data/%s.ply" % (
                #     shape_item
                # )

                gt_shape_path = "%s/%s/input_pts/%s.ply" % (
                    base_dir,
                ...
                if os.path.exists(npy_path):
                    ...
                    if gt_shape_path in gt_cache.keys():
                        ...
                        if isinstance(gt_mesh, trimesh.Trimesh):
                            ...
                            gt_normals = gt_pointcloud
                            # gt_normals = np.stack([e["vertex"]["nx"], plydata["vertex"]["ny"], plydata["vertex"]["nz"]], axis=1)
                        else:
                        ...
                        if N > n_points:
                            indice = np.random.choice(N, n_points, False)
                            gt_pointcloud = gt_pointcloud[indice, :]
                            gt_normals = gt_normals[indice, :]
                    ...
                    if True:
                        ...
                        # if shape_item == "gargoyle" and method_item == "DiGS":
                        #     mesh.vertices *= 1.1
    ...
    df.to_csv("%s/srb_compare_compare_sampling.csv" % (metric_save_dir))
