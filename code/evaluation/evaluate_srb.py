...
if __name__ == "__main__":
    ...
    methods_name = ["SAP", "NP", "SAL", "SALD", "IGR", "DeepMLS", "DiGS_official_epoch", "SSNFitting_CVPR_10000_EPOCH", "PSR"]
    ...
    metric_save_dir = "metric_main_compares_SRB_v1"
    ...
    for idx, type_item in enumerate(data_type):
        ...
        for method_idx, method_item in enumerate(methods_name):
            ...
            save_dir = "SRB_%s_%s_%dp_epoch_final_compare_all_CVPR111111" % (method_item, type_item, n_points)
