...
if __name__ == "__main__":
    ...
    # methods_name = ["SAP", "SALD", "run_SSN_Fitting_code_v8_run_SSN_Fitting_thinigi_new_1_v1"]
    # base_dir = "/research/d5/gds/rszhu22/SSN_Fitting_current/code_v8/reconstruction/evaluate/"
    base_dir = "/research/d5/gds/rszhu22/SSN_Fitting_current/code/reconstruction/evaluate/"
    all_datatype_dir = generate_dir()
    # methods_name=["Our", "SAP","NP", "DeepMLS"]
    # methods_name=["derivative_ablation", "signed_ablation"]
    # method_list = [] 0 1 2 3
    methods_name = ["Ablation_voxel_v1_0", "SSNFitting_CVPR_10000_EPOCH", "Ablation_voxel_v1_2"]
    # methods_name = [
    #     "Ablation_voxel_v3_0", "Ablation_voxel_v3_1", "SSNFitting_CVPR_10000_EPOCH", "Ablation_voxel_v3_2", "Ablation_voxel_v3_3"
    # ]
    # methods_name = ["Ablation_voxel_v1_0", "Ablation_voxel_v1_1", "Ablation_voxel_v1_2", "Ablation_voxel_v1_3"]
    # methods_name = [
    #     "SAP", "SSNFitting_CVPR_screen", "DiGS", "IGR", "SAL", "SALD", "IGR_wo_unoriented_PE_6", "IGR_wo_unoriented_PE_3",
    #     "IGR_wo_unoriented", "IGR_oriented", "IGR_w_signed_supervision", "SSNFitting_CVPR_10000_EPOCH", "DiGS_official_epoch",
    #     "ABLATION_TS", "ABLATION_TS_16384", "ABLATION_SIGNED", "ABLATION_DS", "ABLATION_PE", "PSR", "IGR_calculated_oriented",
    #     "empty_uniform_v5_precalc_v2_signed_PE_6", "ABLATION_signed_distance_supervision", "POCO", "SPSR_DP"
    # ]

    # save_path_dict["IGR_wo_unoriented_PE_6"] = "/research/d5/gds/rszhu22/SSN_Fitting_current/code_v8/exps/IGR_wo_unoriented_PE_6/"
    # save_path_dict["IGR_wo_unoriented_PE_3"] = "/research/d5/gds/rszhu22/SSN_Fitting_current/code_v8/exps/IGR_wo_unoriented_PE_3/"
    # save_path_dict["IGR_wo_unoriented"] = "/research/d5/gds/rszhu22/SSN_Fitting_current/code_v8/exps/IGR_wo_unoriented/"
    ...
    metric_save_dir = "CVPR_metric_main_compares_thingi_orientation_voxel_size"
    ...
    for idx, type_item in enumerate(data_type):
        ...
        for method_idx, method_item in enumerate(methods_name):
            ...
            for shape_item in shape_list:
                ...
                gt_shape_path = "%s/%s/GT/%s.ply" % (
                    base_dir,
                    all_datatype_dir[type_item],
                    shape_item,
                )
    ...
    df.to_csv("%s/CVPR_thingi_orientation_rebuttal_version.csv" % (metric_save_dir))
