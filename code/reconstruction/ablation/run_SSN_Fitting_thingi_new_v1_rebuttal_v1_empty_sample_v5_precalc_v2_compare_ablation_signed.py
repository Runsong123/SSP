...
class ReconstructionRunner:
    ...
    def run(self):
        ...
        for epoch in range(self.startepoch, self.nepochs + 1):
            ...
            uniform_free_grid_pns = torch.from_numpy(uniform_free_grid).float().cuda().requires_grad_()
    ...
    def __init__(self, **kwargs):
        ...
        self.other_data = np.concatenate([self.other_data, self.surface_grid, self.empty_data], axis=0)
