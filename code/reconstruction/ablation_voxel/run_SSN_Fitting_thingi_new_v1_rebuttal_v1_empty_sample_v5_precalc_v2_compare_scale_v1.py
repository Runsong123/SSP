...
class ReconstructionRunner:
    ...
    def __init__(self, **kwargs):
        ...
        if kwargs["dataset"] == "abc_noisefree" or kwargs["dataset"] == "famous_noisefree" or kwargs["dataset"] == "thingi":
            ...
            files_name = glob.glob("%s_%s_adaptive_more_grid11_density_boundary_depth_scale/%d/%s_grid_*.txt" % (
            ...
            self.empty_file = "%s_%s_adaptive_more_grid11_density_boundary_depth_scale/%d/%s_empty_%d_pts.txt" % (
                "/research/d5/gds/rszhu22/SSN_Fitting_current/data/adaptive_more_grid/output_res_1",
                kwargs["dataset"],
                self.scale_id,
                kwargs["shape"],
            ...
            self.surface_grid_file = "%s_%s_adaptive_more_grid11_density_boundary_depth_scale/%d/%s_grid_%d_pts_%d.txt" % (
                "/research/d5/gds/rszhu22/SSN_Fitting_current/data/adaptive_more_grid/output_res_1",
                kwargs["dataset"],
                self.scale_id,
                kwargs["shape"],
            ...
            self.other_grid_file = "%s_%s_adaptive_more_grid11_density_boundary_depth_scale/%d/%s_other_%d_pts.txt" % (
                "/research/d5/gds/rszhu22/SSN_Fitting_current/data/adaptive_more_grid/output_res_1",
                kwargs["dataset"],
                self.scale_id,
                kwargs["shape"],
